          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      Schau dir unsere vielfältige Speisekarte an und wähle
                      deine Lieblingsgerichte aus.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text25">Bestelle und bezahle</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Füge die gewünschten Speisen und Getränke zu deinem
                      Warenkorb hinzu und bezahle bequem online oder vor Ort.
                    </span>
                  </Fragment>
                )}
              </span>
