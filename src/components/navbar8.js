        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            <Link to="/" className="navbar8-link11 thq-link thq-body-small">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text16">Start</span>
                </Fragment>
              )}
            </Link>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text20">Speisekarte</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text15">Über uns</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <Link to="/contact" className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Kontakt</span>
                  </Fragment>
                )}
              </Link>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text26">Anrufen</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text13">
                                  Willkommen auf unserer Startseite. Entdecken
                                  Sie unsere leckeren Angebote!
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Schauen Sie sich unsere vielfältige
                                  Speisekarte an und wählen Sie Ihre
                                  Lieblingsgerichte.
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text19">Über uns</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text18">
                                  Erfahren Sie mehr über uns, unsere Geschichte
                                  und unser Team.
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text14">Kontakt</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
            ...
            <div className="navbar8-buttons2">
              <button className="thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text21">Bestellen</span>
                    </Fragment>
                  )}
                </span>
              </button>
                ...
                <div className="navbar8-menu-item5">
                  ...
                  <div className="navbar8-content5">
                    <span className="navbar8-page12 thq-body-large">
                      {props.page1 ?? (
                        <Fragment>
                          <span className="navbar8-text25">Startseite</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text13">
                            Willkommen auf unserer Startseite. Entdecken Sie
                            unsere leckeren Angebote!
                          </span>
                        </Fragment>
                      )}
                    </span>
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text17">Speisekarte</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text22">
                            Schauen Sie sich unsere vielfältige Speisekarte an
                            und wählen Sie Ihre Lieblingsgerichte.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text18">
                            Erfahren Sie mehr über uns, unsere Geschichte und
                            unser Team.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text24">
                            Nehmen Sie Kontakt mit uns auf. Wir freuen uns auf
                            Ihre Anfragen!
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page4: undefined,
  page4ImageAlt: 'Bild Kontakt',
  linkUrlPage1: 'https://www.teleporthq.io',
  page2ImageAlt: 'Bild Speisekarte',
  linkUrlPage3: 'https://www.teleporthq.io',
  link3Url: 'https://www.teleporthq.io',
  link3: undefined,
  logoAlt: 'Imbiss Logo',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1600713080871-116c252a520e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDEyNTMzMHw&ixlib=rb-4.0.3&q=80&w=1080',
  link1: undefined,
  page1ImageAlt: 'Bild Startseite',
  page2: undefined,
  page3Description: undefined,
  page3ImageAlt: 'Bild Über uns',
  linkUrlPage4: 'https://www.teleporthq.io',
  page3: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1523950300486-6be20a1b1f60?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDEyNTMzMXw&ixlib=rb-4.0.3&q=80&w=1080',
  link2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1612864417332-a0cd239be8fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDEyNTMzMHw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1604927970771-465fddcee6a2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDEyNTMzMXw&ixlib=rb-4.0.3&q=80&w=1080',
